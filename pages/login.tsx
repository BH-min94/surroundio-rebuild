    ...
    return (
        <>
            ...
            <div className="bg-black pt-44 pb-10 lg:px-24 px-16">
                ...
                >
                    <h1 className="text-white lg:text-6xl text-3xl mt-16 text-center">Login</h1>
                    <div className="mt-16">
                        <motion.div
                            initial={{ opacity: 0, }}
                            animate={{ opacity: 1 }}
                        ...
                        >
                            <div className="flex lg:justify-between lg:gap-5 lg:flex-row flex-col gap-2">
                                <button 
                                    className="flex justify-center items-center gap-3 bg-white rounded-md py-3 px-5 text-gray-600 lg:text-sm text-xs lg:w-1/2 hover:bg-slate-200 transition">
                                    <svg
                                        className="w-4 h-4"
                                        aria-hidden="true"
                                        fill="black"
                            ...
                            <div className="relative mt-8">
                                ...
                                <div className="relative -top-3 text-center ">
                                    <span className="bg-black px-5 text-sm text-gray-500">
                                        No Account?
                                        <Link href="/signup" className="ml-3 hover:text-white transition font-semibold text-base">
                                            Sign Up
                                        </Link>
                                    </span>
                                </div>
